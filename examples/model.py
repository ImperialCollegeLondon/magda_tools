...
parser = argparse.ArgumentParser(
    description="Plot the magnetic field strength from a Magda flat file predicted"
    " by a three term harmonic expansion model"
)
parser.add_argument("FFD_file", type=str, help="Path to a Magda flat file")
args = parser.parse_args()

# initialise model with coefficients for expansion terms
